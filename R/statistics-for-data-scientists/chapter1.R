...
state <- read.csv(file.path(PSDS_PATH, 'data/psds_data', 'state.csv'))
dfw <- read.csv(file.path(PSDS_PATH, 'data/psds_data', 'dfw_airline.csv'))
sp500_px <- read.csv(file.path(PSDS_PATH, 'data/psds_data', 'sp500_px.csv'))
sp500_sym <- read.csv(file.path(PSDS_PATH, 'data/psds_data', 'sp500_sym.csv'), stringsAsFactors = FALSE)
kc_tax <- read.csv(file.path(PSDS_PATH, 'data/psds_data', 'kc_tax.csv'))
lc_loans <- read.csv(file.path(PSDS_PATH, 'data/psds_data', 'lc_loans.csv'))
airline_stats <- read.csv(file.path(PSDS_PATH, 'data/psds_data', 'airline_stats.csv'), stringsAsFactors = FALSE)
